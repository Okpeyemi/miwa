...
const Logo = ({ className }: { className?: string }) => {
  return (
    <svg viewBox="0 0 78 18" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
...
const brandName = "MIWA"

function MiwaFooter() {
  return (
    <section className="container w-full">
      <Footer
        logo={<span className="text-4xl font-bold text-miwa-gradient">miwa</span>}
        brandName={brandName}
        socialLinks={[
          {
          ...
          },
          {
            ...
            href: "https://github.com/miwa",
            label: "GitHub",
          },
          {
            icon: <Linkedin className="h-4 w-4 sm:h-5 sm:w-5" />,
            href: "https://linkedin.com/company/miwa",
            label: "LinkedIn",
          },
          {
            icon: <Mail className="h-4 w-4 sm:h-5 sm:w-5" />,
            href: "mailto:contact@miwa.com",
            label: "Email",
          },
        ]}
        mainLinks={[
        ...
        copyright={{
          text: "© 2024 MIWA Analytics Platform",
